...
若提示 `host 192.168.1.241 is alive` 说明开发板和 Ubuntu 主机网络连接正常。
...
```textile
/home/tengfei/linux/nfs/buildroot 192.168.1.0/24(rw,sync,no_subtree_check,no_root_squash)
```
...
```shell
nfs 80800000 192.168.1.241:/home/tengfei/linux/nfs/rootfs/zImage
```

表示将 Ubuntu 主机 `192.168.1.241` 上 `/home/tengfei/linux/nfs/rootfs/zImage` 文件通过 NFS 下载到开发板 DRAM 的 `0x80800000` 地址处。
...
```textile
TFTP_USERNAME="tftp"
TFTP_DIRECTORY="/home/tf/linux/tftp/"
